...
public class IconPackManager
{
    ...
    public class IconPack
    {
        ...
        public void load()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        Log.d("IconPackManager", "No appfilter.xml file");
                    }
                }
            ...
            {
                Log.d("IconPackManager", "Cannot load icon pack");
            }
            catch (XmlPullParserException e)
            {
                Log.d("IconPackManager", "Cannot parse icon pack appfilter.xml");
            }
            catch (IOException e) {
                e.printStackTrace();
            }
        ...
        public Drawable getDrawableIconForPackage(String appPackageName, Drawable defaultDrawable) {
            ...
            Intent launchIntent = vapm.getLaunchIntentForPackage(appPackageName);
            String componentName = null;
            if (launchIntent != null)
                componentName = vapm.getLaunchIntentForPackage(appPackageName).getComponent().toString();
        ...
        public Bitmap getIconForIntent(Intent launchIntent, String appPackageName, Bitmap defaultBitmap)
        {
            if (!mLoaded)
                load();
            ...
            String componentName = null;
            if (launchIntent != null)
                componentName = launchIntent.getComponent().toString();
            String drawable = mPackagesDrawables.get(componentName);
            if (drawable != null)
            {
                return loadBitmap(drawable);
...
//            BitmapCache.getInstance(mContext).putBitmap(key, result);
    ...
    public HashMap<String, IconPack> getAvailableIconPacks(PackageManager vapm, PackageManager pm, boolean forceReload)
    {
        this.vapm = vapm;
        this.pm = pm;
